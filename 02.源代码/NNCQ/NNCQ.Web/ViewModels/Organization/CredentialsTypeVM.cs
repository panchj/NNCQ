...
{
    [EditorSpecification("CredentialsType", "个人证件类型定义数据", true, SaveAction = "Save", ListString = "List")]
    [ListHeadSpecification("个人证件类型定义数据管理", ControllerName = "CredentialsType", SearchActionPath = "", CreateActionPath = "CreateOrEdit")]
    [ListDataGridViewSpecification("CredentialsType", 18, ListActionPath = "List", EditActionPath = "CreateOrEdit", DetailActionPath = "Detail", DeleteActionPath = "Delete")]
    public class CredentialsTypeVM
    {
        [Key]

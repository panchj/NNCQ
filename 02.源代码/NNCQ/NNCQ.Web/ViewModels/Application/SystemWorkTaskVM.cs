...
{
    [EditorSpecification("SystemWorkSection", "操作导航子菜单定义数据", true, SaveAction = "Save", ListString = "List")]
    [ListHeadSpecification("操作导航子菜单定义数据管理", ControllerName = "SystemWorkSection", SearchActionPath = "", CreateActionPath = "CreateOrEdit")]
